...
const (
	...
	remoteRefImport = `github.com/dimkaufo/oapi-codegen/v2/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/dimkaufo/oapi-codegen/v2/examples/petstore-expanded"`)
